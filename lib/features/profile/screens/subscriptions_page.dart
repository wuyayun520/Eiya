...
class _SubscriptionsPageState extends State<SubscriptionsPage> with TickerProviderStateMixin {
  ...
  Future<void> _handleSuccessfulPurchase(PurchaseDetails purchaseDetails) async {
    ...
    DateTime expiry;
    if (purchaseDetails.productID == 'EiyaWeekVIP') {
      expiry = now.add(const Duration(days: 7));
    } else if (purchaseDetails.productID == 'EiyaMonthVIP') {
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<_Privilege>> planPrivileges = [
      // Weekly
      [
        _Privilege(icon: Icons.pets, text: 'Unlimited access to pet content'),
      ...
      [
        ...
        _Privilege(icon: Icons.block, text: 'Ad-free experience'),
        _Privilege(icon: Icons.star, text: 'Unlimited modification of user avatars'),
        _Privilege(icon: Icons.favorite, text: 'Unlimited communication with other pet owners'),
      ],
    ];
                      ...
                      child: SafeArea(
                        child: Column(
                          ...
                          children: [
                            ...
                            // Subtitle
                            Text(
                              'Unlock unlimited pet experience',
                              style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(
                              onPressed: () => _launchURL('https://www.privacypolicies.com/live/79154c2c-451e-4e39-8e56-31e414f2f10c'),
                              child: Text(
                                'Privacy Policy',
                                style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                '3. Tap Subscriptions\n'
                                '4. Find Pet Premium in the list\n'
