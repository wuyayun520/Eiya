...
class SubmarineViewController: StartThen {
    ...
    lazy var topView: StackView = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = StackView(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: MyJoinViewReactiveCompatible = {
    ...
    lazy var usePhotoView: ServerThen = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = ServerThen(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension SubmarineViewController {
    ...
    func trepan(modle: KeyMomentModel) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==DistanceAppManager.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == DistanceAppManager.share.loginUserMode.sex
        }
