...
/*: "icon_chat_start" :*/
fileprivate let kWhiteName:[Character] = ["i","c","o","n","_","c","h","a","t","_","s","t","a","r","t"]

/*: "#752FE9" :*/
fileprivate let k_pushSucceedUrl:String = "#752FE9at make info make size"

/*: "#F5F5F5" :*/
fileprivate let k_changeName:[Character] = ["#"]
fileprivate let kMaleId:String = "Fequalequal5"

/*: "@ :*/
fileprivate let k_dataFillMessage:[Character] = ["@"]

/*: "btn_feed_dianzan_nor" :*/
fileprivate let k_phoneMsg:[UInt8] = [0x72,0x6f,0x6e,0x5f,0x6e,0x61,0x7a,0x6e,0x61,0x69,0x64,0x5f,0x64,0x65,0x65,0x66,0x5f,0x6e,0x74,0x62]

/*: "btn_feed_reply_nor" :*/
fileprivate let k_plainMakePath:[Character] = ["b","t","n","_","f","e","e","d","_","r","e","p","l","y","_"]
fileprivate let k_bindModelData:String = "ngroupr"
...
class PlayUpFeedCell: UITableViewCell {
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.submitGift(name: (String(kWhiteName)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var nickNameLab: UILabel = {
        ...
        lab.font = UIFont.tapShared(fontSize: 16)
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(k_pushSucceedUrl.prefix(7))))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(k_changeName) + kMaleId.replacingOccurrences(of: "equal", with: "5F")))
...
extension PlayUpFeedCell {
    /// 刷新cell
    //: func refreshCell(_ model: TalkingRemindListModel) {
    func lastCurrent(_ model: SizeValueListModel) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.tarotCard())
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: k_phoneMsg.reversed(), encoding: .utf8)! : (String(k_plainMakePath) + k_bindModelData.replacingOccurrences(of: "group", with: "o"))
        //: statusIcon.image = UIImage.submitGift(name: typeImgStr)
        statusIcon.image = UIImage.submitGift(name: typeImgStr)
...
extension PlayUpFeedCell {
    ...
    private func shove() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((constFormalContent - 128) / 2)
        }
