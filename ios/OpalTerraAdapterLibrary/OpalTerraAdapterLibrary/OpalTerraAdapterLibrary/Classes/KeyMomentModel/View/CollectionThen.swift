...
fileprivate let kColorRenderViewName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class CollectionThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kColorRenderViewName.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var progressView: GlassesView = {
        ...
        let v = GlassesView(frame: self.frame, progressBgColor: self.progressBgColor, progressPlayedColor: self.progressPlayedColor, progressCachedColor: self.progressCachedColor)
    ...
    private lazy var panGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(mutual(gesture:)))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(inputKey(gesture:)))
        //: return v
        return v
        //: }()
    }()
...
extension CollectionThen {
    ...
    @objc func mutual(gesture: UIPanGestureRecognizer) {
        // 移动的距离
    ...
    @objc func inputKey(gesture: UIPanGestureRecognizer) {
