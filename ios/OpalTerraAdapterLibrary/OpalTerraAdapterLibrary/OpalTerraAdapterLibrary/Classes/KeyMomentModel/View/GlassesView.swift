...
fileprivate let k_onPath:[UInt8] = [0x92,0x95,0x92,0x8f,0xd3,0x98,0x94,0x9f,0x9e,0x89,0xc1,0xd2,0xdb,0x93,0x9a,0x88,0xdb,0x95,0x94,0x8f,0xdb,0x99,0x9e,0x9e,0x95,0xdb,0x92,0x96,0x8b,0x97,0x9e,0x96,0x9e,0x95,0x8f,0x9e,0x9f]

private func labelPath(application num: UInt8) -> UInt8 {
    return num ^ 251
}
...
class GlassesView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_onPath.map{labelPath(application: $0)}, encoding: .utf8)!)
    }
...
extension GlassesView {
    ...
    private func atQuantityeraction() {
