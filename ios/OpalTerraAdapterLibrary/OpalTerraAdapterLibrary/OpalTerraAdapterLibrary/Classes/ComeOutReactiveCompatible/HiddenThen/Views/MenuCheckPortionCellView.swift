...
fileprivate let kSubName:[UInt8] = [0xa3,0xa4,0xa3,0xbe,0xe2,0xa9,0xa5,0xae,0xaf,0xb8,0xf0,0xe3,0xea,0xa2,0xab,0xb9,0xea,0xa4,0xa5,0xbe,0xea,0xa8,0xaf,0xaf,0xa4,0xea,0xa3,0xa7,0xba,0xa6,0xaf,0xa7,0xaf,0xa4,0xbe,0xaf,0xae]

/*: "icon_lounge" :*/
fileprivate let k_viewText:String = "icon_list push app black system"

/*: "#777777" :*/
fileprivate let k_nameStatuteStr:[Character] = ["#","7","7","7","7","7","7"]

/*: "UID: :*/
fileprivate let kCurrentEqualMsg:String = "UID:cell control view frame receive"
...
// __CLOSE_PRINT__
//
//  MenuCheckPortionCellView.swift
//  AbroadTalking
//
...
class MenuCheckPortionCellView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kSubName.map{$0^202}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.submitGift(name: (String(k_viewText.prefix(5)) + "lounge"))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(k_nameStatuteStr)))
        //: return lab
        return lab
        //: }()
    }()
...
extension MenuCheckPortionCellView {
    /// 刷新
    //: func refreshCell(model: TalkingRecommendUserModel) {
    func unfearingShow(model: PerformanceHandyJSON) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.setUrlImage(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.colorStatuteNameApp()
        nicknameLab.textColor = model.loungePlus ? .usufructuaryHeadSkinColour() : .colorStatuteNameApp()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(kCurrentEqualMsg.prefix(4))) + "\(model.uid)"
