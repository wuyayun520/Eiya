...
/*: "id" :*/
fileprivate let kOutputKey:String = "bar"
...
struct RangeMeasurable: HandyJSON {
    //: var gid: String!
    var gid: String! // 礼物Id
    //: var price: Int = 0
...
struct PublishHandyJSON: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct WithHandyJSON: HandyJSON {
