...
fileprivate let k_backgroundVideoPath:[UInt8] = [0x61,0x66,0x61,0x7c,0x20,0x6b,0x67,0x6c,0x6d,0x7a,0x32,0x21,0x28,0x60,0x69,0x7b,0x28,0x66,0x67,0x7c,0x28,0x6a,0x6d,0x6d,0x66,0x28,0x61,0x65,0x78,0x64,0x6d,0x65,0x6d,0x66,0x7c,0x6d,0x6c]
...
class ModelItemLabel: UIView {
    ...
    private var giftSendItem = [PublishHandyJSON()]
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_backgroundVideoPath.map{$0^8}, encoding: .utf8)!)
    }
    ...
    func forewordRobot(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.scaleValueTo()
    ...
    func atChaseFrame(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.behindVoice(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.behindVoice(253, 170, 52, 1).cgColor, // 深黄
        ]
