...
fileprivate let kReadKey:[UInt8] = [0xab,0xac,0xab,0xb6,0xea,0xa1,0xad,0xa6,0xa7,0xb0,0xf8,0xeb,0xe2,0xaa,0xa3,0xb1,0xe2,0xac,0xad,0xb6,0xe2,0xa0,0xa7,0xa7,0xac,0xe2,0xab,0xaf,0xb2,0xae,0xa7,0xaf,0xa7,0xac,0xb6,0xa7,0xa6]

private func dayObject(live num: UInt8) -> UInt8 {
    return num ^ 194
}

/*: "icon_coinxxx" :*/
fileprivate let k_giftVoiceMsg:String = "icon_attach style make should make"

/*: "icon_gift_num_bg" :*/
fileprivate let k_requestContent:String = "icon_gifvideo medium"
fileprivate let kBlockValue:String = "icon beauty kind path progresst_nu"

/*: "x1" :*/
fileprivate let kMessageKey:String = "post1"

/*: " x :*/
fileprivate let k_kindPath:String = "return object type color color x"
...
class CustomView: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kReadKey.map{dayObject(live: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var nameLB: UILabel = {
        //: let lb = UILabel.init()
        let lb = UILabel()
        //: lb.font = UIFont.fontChange(type: .Regular, fontSize: 10)
        lb.font = UIFont.fontChange(type: .Regular, fontSize: 10)
        //: lb.textColor = .white
        lb.textColor = .white
    ...
    lazy var priceBtn: ResumeControl = {
        //: let btn = TalkingButton.init()
        let btn = ResumeControl()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.fontChange(type: .Regular, fontSize: 10)
        btn.titleLabel?.font = UIFont.fontChange(type: .Regular, fontSize: 10)
        //: btn.setImage(UIImage.submitGift(name: "icon_coinxxx"), for: .normal)
        btn.setImage(UIImage.submitGift(name: (String(k_giftVoiceMsg.prefix(5)) + "coinxxx")), for: .normal)
    ...
    lazy var numBgView: UIImageView = {
        ...
        let img = UIImageView()
        //: let imag = UIImage.submitGift(name: "icon_gift_num_bg")
        let imag = UIImage.submitGift(name: (String(k_requestContent.prefix(8)) + String(kBlockValue.suffix(4)) + "m_bg"))
        //: let sizex = imag.size
        let sizex = imag.size
    ...
    lazy var numLb: UILabel = {
        ...
        //: lb.text = "x1"
        lb.text = "x1"
        //: lb.font = UIFont.fontChange(type: .Regular, fontSize: 9)
        lb.font = UIFont.fontChange(type: .Regular, fontSize: 9)
        //: return lb
        return lb
        //: }()
...
extension CustomView {
    ...
    func constraintIn(checked: Bool) {
        ...
        if checked {
            ...
            bgView.layer.borderColor = UIColor.increase().cgColor
    ...
    func searchedFlushRoundnessFewness(number: Int) {
    ...
    func compartmentType(currenmodel: RangeMeasurable, giftType: AddSubscriptType) {
        //: model = currenmodel
        model = currenmodel
        ...
        paraph.alignment = .center
        //: let attributes = [NSAttributedString.Key.font: UIFont.fontChange(type: .Regular, fontSize: 11),
        let attributes = [NSAttributedString.Key.font: UIFont.fontChange(type: .Regular, fontSize: 11),
...
extension CustomView {
    ...
    func atUi() {
        ...
        bgView.backgroundColor = UIColor.getToColor()
