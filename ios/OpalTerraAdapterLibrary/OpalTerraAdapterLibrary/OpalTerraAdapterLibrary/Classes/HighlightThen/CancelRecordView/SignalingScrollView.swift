...
open class SignalingScrollView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = SignalingScrollView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func quickEqual() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(draftInsideHarm),
    ...
    @objc private func draftInsideHarm() {
