...
fileprivate let kManagerText:[UInt8] = [0xab,0xac,0xab,0xb6,0xea,0xa1,0xad,0xa6,0xa7,0xb0,0xf8,0xeb,0xe2,0xaa,0xa3,0xb1,0xe2,0xac,0xad,0xb6,0xe2,0xa0,0xa7,0xa7,0xac,0xe2,0xab,0xaf,0xb2,0xae,0xa7,0xaf,0xa7,0xac,0xb6,0xa7,0xa6]

/*: "SHBDropMenuCell" :*/
fileprivate let kNoseName:String = "SHBDrmodel model add"
fileprivate let k_toRenderId:[Character] = ["C","e","l","l"]

/*: "title" :*/
fileprivate let kIconFrameStr:String = "tendle"
...
public class AddDataSource: UIView {
    //: var menuDelegate: DropDownMenuViewDelegate?
    var menuDelegate: WillSizeViewDelegate?
    ...
    var menuBgColor: UIColor? {
        ...
        //: }
    } // = Config.CoverConfig.menuBgColor
    // 线条颜色
    //: var lineColor = Config.MenuCellConfig.lineColor
    var lineColor = Config.ValueContent.lineColor
    // cell高度
    //: public var menuCellHeight = Config.MenuCellConfig.menuCellHeight
    public var menuCellHeight = Config.ValueContent.menuCellHeight
    /**
     *  table最大高度限制
     *  默认：5 * cellHeight
     */
    //: var menuMaxHeight = Config.MenuCellConfig.menuMaxHeight
    var menuMaxHeight = Config.ValueContent.menuMaxHeight
    /**
     *  小三角高度
     *  45°等腰三角形
     */
    ...
    public var menuStyle = Config.initialMenuStyle ?? GroupMenuStyle.MenuDarkStyle {
        //: didSet {
        didSet {
            //: switch menuStyle {
            switch menuStyle {
...
//        menuView.refreshUI()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kManagerText.map{$0^194}, encoding: .utf8)!)
    }

    //: private func makeContentView() -> UIView {
    private func towardWith() -> UIView {
        //: let view  = UIView()
        let view = UIView()
        //: return view
        return view
    ...
    private func groupEvent() -> UITableView {
    ...
    private func dollSHouse() {
        //: addSubview(contentView)
        addSubview(contentView)
        //: mTable.register(DropMenuCell.self, forCellReuseIdentifier: "SHBDropMenuCell")
        mTable.register(MenuCell.self, forCellReuseIdentifier: (String(kNoseName.prefix(5)) + "opMenu" + String(k_toRenderId)))
...
extension AddDataSource: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: (String(kNoseName.prefix(5)) + "opMenu" + String(k_toRenderId)), for: indexPath) as! MenuCell
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        selectionAction?(indexPath.row, cellModel.title ?? (kIconFrameStr.replacingOccurrences(of: "end", with: "it")))
        //: animateRemoveView()
        jumpOn()

        //: menuDelegate?.didClickSelectedRow(index: indexPath.row, title: cellModel.title ?? "")
        menuDelegate?.nonePlayer(index: indexPath.row, title: cellModel.title ?? "")
    }
}
