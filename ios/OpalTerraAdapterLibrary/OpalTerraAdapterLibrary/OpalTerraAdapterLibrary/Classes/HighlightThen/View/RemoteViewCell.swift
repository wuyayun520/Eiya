...
fileprivate let kAddSharedMessage:[UInt8] = [0xc8,0xcf,0xc8,0xd5,0x89,0xc2,0xce,0xc5,0xc4,0xd3,0x9b,0x88,0x81,0xc9,0xc0,0xd2,0x81,0xcf,0xce,0xd5,0x81,0xc3,0xc4,0xc4,0xcf,0x81,0xc8,0xcc,0xd1,0xcd,0xc4,0xcc,0xc4,0xcf,0xd5,0xc4,0xc5]

/*: "icon_home_boy" :*/
fileprivate let kMakeStr:String = "icequal"
fileprivate let k_imageKey:String = "e_boystatus remind"

/*: "icon_home_girl" :*/
fileprivate let k_selectedName:String = "iconc"
fileprivate let kDismissAreaId:[Character] = ["o","n","_","h","o","m","e","_","g","i","r","l"]
...
class RemoteViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kAddSharedMessage.map{$0^161}, encoding: .utf8)!)
    }
...
extension RemoteViewCell {
    //: func setOnlineListCell(model: TalkingChatRoomMemberModel, type: TitleType) {
    func keyType(model: RunOutMemberModel, type: CoverEquatable) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.submitGift(name: (kMakeStr.replacingOccurrences(of: "equal", with: "on") + "_hom" + String(k_imageKey.prefix(5)))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.submitGift(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.submitGift(name: (k_selectedName.replacingOccurrences(of: "icon", with: "i") + String(kDismissAreaId))), for: .normal)
        //: break
        //: default:
        default:
            //: break
