...
fileprivate let k_calledMessage:[UInt8] = [0xbd,0xba,0xbd,0xa0,0xfc,0xb7,0xbb,0xb0,0xb1,0xa6,0xee,0xfd,0xf4,0xbc,0xb5,0xa7,0xf4,0xba,0xbb,0xa0,0xf4,0xb6,0xb1,0xb1,0xba,0xf4,0xbd,0xb9,0xa4,0xb8,0xb1,0xb9,0xb1,0xba,0xa0,0xb1,0xb0]

private func fileLeadingReturn(party num: UInt8) -> UInt8 {
    return num ^ 212
}

/*: "btn_me_edit" :*/
fileprivate let k_showName:String = "btn_me_elist segment price view status"
fileprivate let k_successDomainFormat:String = "fieldt"
...
// __CLOSE_PRINT__
//
//  ObjectWillReactiveCompatible.swift
//  AbroadTalking
//
...
class ObjectWillReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_calledMessage.map{fileLeadingReturn(party: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.submitGift(name: (String(k_showName.prefix(8)) + k_successDomainFormat.replacingOccurrences(of: "field", with: "di"))))
...
extension ObjectWillReactiveCompatible {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func finishSeek(titile: String, row: Int, isLast: Bool) {
    ...
    //: func setArrows() {
    func keep() {
        //: titleBLB.font = UIFont.fontChange(type: .Medium, fontSize: 15)
        titleBLB.font = UIFont.fontChange(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.fontChange(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.fontChange(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
    ...
    func analogDigitalConverter(detail: String) {
        //: index = 0
        index = 0
        //: islast = true
        islast = true
