...
fileprivate let k_cellValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_dynamic_stop_nor" :*/
fileprivate let kTitleMsg:[Character] = ["b","t","n","_","d","y","n","a","m","i","c","_","s","t","o","p","_"]
fileprivate let kMainMsg:String = "noselected"
...
class GroupTouchItemCell: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_cellValue.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var playimageView: UIImageView = {
        //: let imag = UIImageView(image: UIImage.submitGift(name: "btn_dynamic_stop_nor"))
        let imag = UIImageView(image: UIImage.submitGift(name: (String(kTitleMsg) + kMainMsg.replacingOccurrences(of: "selected", with: "r"))))
        //: return imag
        return imag
        //: }()
    }()
...
extension GroupTouchItemCell {
    //: func configModel(videoUrl: String, imgUrl: String ) {
    func pathUrl(videoUrl: String, imgUrl: String) {
    ...
    func location() {
        ...
        self.player.dataView(url: videoUrl, view: self.coverView)
...
extension GroupTouchItemCell: PlayerMakeThen {
