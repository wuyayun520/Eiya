...
fileprivate let k_nameUrl:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_gift_placeholder" :*/
fileprivate let kEditFormat:String = "as photoicon_"
fileprivate let kModelMsg:String = "lacpositionold"
fileprivate let kValueReplyMessage:String = "progressr"

/*: "Gift" :*/
fileprivate let kMediumStatuteKey:String = "Giftdata empty"

/*: "x%ld" :*/
fileprivate let kDataMessage:String = "x%ldlist origin mode"
...
class StartViewCell: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_nameUrl.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .behindVoice(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        let imgV = UIImageView()
        //: imgV.image = UIImage.submitGift(name: "icon_gift_placeholder")
        imgV.image = UIImage.submitGift(name: (String(kEditFormat.suffix(5)) + "gift_p" + kModelMsg.replacingOccurrences(of: "position", with: "eh") + kValueReplyMessage.replacingOccurrences(of: "progress", with: "e")))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(kMediumStatuteKey.prefix(4))).localized
