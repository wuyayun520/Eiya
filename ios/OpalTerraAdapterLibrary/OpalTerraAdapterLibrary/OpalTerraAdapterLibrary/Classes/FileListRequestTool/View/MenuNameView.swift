...
fileprivate let k_sectionData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Edit Title" :*/
fileprivate let kWorkMessage:String = "let am selfEdit T"
fileprivate let kDataId:String = "icellle"

/*: "0/ :*/
fileprivate let kTapPath:[Character] = ["0","/"]

/*: "Finish" :*/
fileprivate let kFirstLayerValue:String = "Finishplayer app equal start to"

/*: "btn_delete" :*/
fileprivate let kGiftMessage:[Character] = ["b","t","n","_","d","e","l","e","t","e"]

/*: / :*/
fileprivate let kIconSectionMsg:String = "cell"

/*: "\n" :*/
fileprivate let kConversationUrl:[Character] = ["\n"]
...
class MenuNameView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(preface))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_sectionData.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var titleLabel: UILabel = {
        ...
        lab.text = (String(kWorkMessage.suffix(6)) + kDataId.replacingOccurrences(of: "cell", with: "t")).localized
    ...
    lazy var inputTView: BreakUpTextView = {
    ...
    private lazy var finishBtn: UIButton = {
        ...
        btn.setTitle((String(kFirstLayerValue.prefix(6))).localized, for: .normal)
        ...
        btn.addTarget(self, action: #selector(clickList), for: .touchUpInside)
        //: btn.isEnabled = false
        btn.isEnabled = false
        //: return btn
        return btn
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.setImage(UIImage.submitGift(name: (String(kGiftMessage))), for: .normal)
...
extension MenuNameView: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        ...
        if textView.text.count > lengthLimit {
            ...
            if textNum > lengthLimit && lengthLimit > 0 {
                ...
                textView.text = objectStop(index: lengthLimit, text: textContent)
            }
        }
    ...
    private func objectStop(index: Int, text: String) -> String {
        //: if text.count <= index {
        if text.count <= index {
            //: return text
            return text
