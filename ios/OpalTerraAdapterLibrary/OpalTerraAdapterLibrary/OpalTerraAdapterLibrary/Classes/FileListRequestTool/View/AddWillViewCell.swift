...
fileprivate let kShowMessage:[UInt8] = [0xe0,0xe5,0xe0,0xeb,0x9f,0xda,0xe6,0xdb,0xdc,0xe9,0xb1,0xa0,0x97,0xdf,0xd8,0xea,0x97,0xe5,0xe6,0xeb,0x97,0xd9,0xdc,0xdc,0xe5,0x97,0xe0,0xe4,0xe7,0xe3,0xdc,0xe4,0xdc,0xe5,0xeb,0xdc,0xdb]

fileprivate func sharedEqual(target num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let kImageProgressPath:String = "btn_memodel shared return task extension"

/*: "Add" :*/
fileprivate let kToMsg:String = "message user makeAdd"
...
class AddWillViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kShowMessage.map{sharedEqual(target: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.submitGift(name: (String(kImageProgressPath.prefix(6)) + "_edit")))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.scaleValueTo()
        //: lb.textAlignment = .right
        lb.textAlignment = .right
        //: lb.text = "Add".localized
        lb.text = (String(kToMsg.suffix(3))).localized
        //: lb.isHidden = true
        lb.isHidden = true
        //: return lb
        return lb
...
extension AddWillViewCell {
    //: func setCellMessage(titile: String, iconStr: String, isShowDet:Bool) {
    func nameSet(titile: String, iconStr: String, isShowDet: Bool) {
        //: titleBLB.text = titile
        titleBLB.text = titile
        //: iconImg.image = UIImage.submitGift(name: iconStr)
        iconImg.image = UIImage.submitGift(name: iconStr)
