...
fileprivate let k_makeUrl:String = "UserDto random model repeat"
fileprivate let kParaFormat:String = "user submit shadow shadowTagM"
fileprivate let kContentMessage:[Character] = ["e","C","e","l","l","I","D"]

/*: "UserDetailTagInterestCellID" :*/
fileprivate let kUsedName:String = "var modify to allUser"
fileprivate let kAtManagerPath:[Character] = ["T","a","g","I","n","t","e","r","e","s","t","C","e","l","l","I","D"]

/*: "AIHobbyCellID" :*/
fileprivate let k_fillNameMsg:String = "model downAIHob"
...
class TitleViewDelegate: StartThen {
    ...
    private var tableHeightModel = CustomResumeReactiveCompatible() // 记录分区高度
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: dataItemSystemValue, right: 0)
        ...
        tableView.register(DataThen.self, forCellReuseIdentifier: DataThen.className())
        //: tableView.register(TalkingUserDetailTagCell.self, forCellReuseIdentifier: "UserDetailTagMeCellID")
        tableView.register(FarThen.self, forCellReuseIdentifier: (String(k_makeUrl.prefix(5)) + "etail" + String(kParaFormat.suffix(4)) + String(kContentMessage)))
        //: tableView.register(TalkingUserDetailTagCell.self, forCellReuseIdentifier: "UserDetailTagInterestCellID")
        tableView.register(FarThen.self, forCellReuseIdentifier: (String(kUsedName.suffix(4)) + "Detail" + String(kAtManagerPath)))
        //: tableView.register(TalkingUserDetailGiftCell.self, forCellReuseIdentifier: TalkingUserDetailGiftCell.className())
        tableView.register(ChecklistReactiveCompatible.self, forCellReuseIdentifier: ChecklistReactiveCompatible.className())
        //: tableView.register(TalkingUserDetailTagCell.self, forCellReuseIdentifier: "AIHobbyCellID")
        tableView.register(FarThen.self, forCellReuseIdentifier: (String(k_fillNameMsg.suffix(5)) + "byCellID"))
        //: return tableView
        return tableView
        //: }()
    }()
...
extension TitleViewDelegate: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellType: CustomCellType = self.sectionArr[indexPath.section]
        //: switch cellType {
        switch cellType {
        //: case .profileType:
        case .profileType:
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: DataThen.className(), for: indexPath) as! DataThen
            //: cell.configWithDataModel(userModel: userInfoModel)
            cell.ribbon(userModel: userInfoModel)
            //: self.setProfileCellHeight(signAttribute: cell.signLab.attributedText ?? NSAttributedString.init(string: ""))
            self.iconCell(signAttribute: cell.signLab.attributedText ?? NSAttributedString(string: ""))
            //: return cell
            return cell
        ...
        case .aboutMeType:
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: (String(k_makeUrl.prefix(5)) + "etail" + String(kParaFormat.suffix(4)) + String(kContentMessage)), for: indexPath) as! FarThen
            //: cell.configTagCellWithDataModel(type: TUserDetailCellType.aboutMeType, userModel: userInfoModel)
            cell.restriction(type: CustomCellType.aboutMeType, userModel: userInfoModel)
        ...
        case .intersetsType:
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: (String(kUsedName.suffix(4)) + "Detail" + String(kAtManagerPath)), for: indexPath) as! FarThen
            //: cell.configTagCellWithDataModel(type: TUserDetailCellType.intersetsType, userModel: userInfoModel)
            cell.restriction(type: CustomCellType.intersetsType, userModel: userInfoModel)
            //: cell.collectionLayoutSubviewBlock = {[weak self] collectH in
            cell.collectionLayoutSubviewBlock = { [weak self] collectH in
                //: guard let self = self else { return }
                guard let self = self else { return }
        ...
        case .giftType:
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: ChecklistReactiveCompatible.className(), for: indexPath) as! ChecklistReactiveCompatible
    ...
    func tableView(_: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        case .aboutMeType:
            ...
            return self.swaddlingClothesHeight()
        //: case .intersetsType:
        case .intersetsType:
...
extension TitleViewDelegate {
    ...
    private func iconCell(signAttribute: NSAttributedString) {
        ...
        var labelH = signAttribute.boundingRect(with: CGSize(width: constFormalContent - 58, height: CGFloat(MAXFLOAT)), options: [.usesLineFragmentOrigin, .usesFontLeading], context: nil).size.height
    ...
    private func swaddlingClothesHeight() -> CGFloat {
    ...
    private func timeHeight() -> CGFloat {
...
extension TitleViewDelegate: JXPagingViewListViewDelegate {
...
extension TitleViewDelegate {
    ...
    func populationProfileTo(_ giftArr: [CoverDoingHandyJSON],
                             //: _ sectionArr: [TUserDetailCellType],
                             _ sectionArr: [CustomCellType],
                             //: _ userModel: TalkingUserInfoModel) {
                             _ userModel: GroupTransformable)
    {
    ...
    private func statisticalMethod() {
