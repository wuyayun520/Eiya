...
/*: "detection" :*/
fileprivate let kDelayMessagePath:[Character] = ["d","e","t","e","c","t","i"]
fileprivate let k_contextMessage:String = "sharen"

/*: "aiff" :*/
fileprivate let k_centerFromAttachPath:String = "rawff"
...
class TouchThen: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = TouchThen()
    ...
    func placeTitle() {
        ...
        let soundFilePath = VideoEffectTool.default.titleType(name: (String(kDelayMessagePath) + k_contextMessage.replacingOccurrences(of: "share", with: "o")), type: (k_centerFromAttachPath.replacingOccurrences(of: "raw", with: "ai")))
