...
/*: "id" :*/
fileprivate let kToKey:String = "infod"
...
struct GroupTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: WillWithSimulationHandyJSON?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [TalkingMeasurable]? // 相册
    ...
    var aiExtraInfo = NameHandyJSON() // AI模型
    //: var vipSkinId = 0
...
struct WillWithSimulationHandyJSON: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
...
struct TalkingMeasurable: HandyJSON {
    ...
    func workplace(compareTo: TalkingMeasurable) -> Bool {
        //: return
        return
...
struct NameHandyJSON: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
