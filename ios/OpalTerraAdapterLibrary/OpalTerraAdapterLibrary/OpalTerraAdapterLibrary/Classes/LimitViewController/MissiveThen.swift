...
class MissiveThen: UINavigationController {

    //: var tabBarType: TabBarItemType?
    var tabBarType: NameWidthMagnitude?
    //: var pushing = false                             
    ...
    override func pushViewController(_ viewController: UIViewController, animated: Bool) {
        ...
        if viewControllers.count >= 1 {
            ...
            if viewController.navigationItem.leftBarButtonItem == nil {
                ...
                viewController.navigationItem.leftBarButtonItem = viewController.titleBind()
            }
        }
    ...
    func playmaker() {
        ...
        if #available(iOS 15.0, *) {
            ...
            barApp.backgroundImage = UIImage.beginLine(color: UIColor.white)
            //: barApp.shadowImage = UIImage.init()
            barApp.shadowImage = UIImage.init()
            //: barApp.shadowColor = UIColor.postColor()
            barApp.shadowColor = UIColor.postColor()
            //: barApp.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.colorStatuteNameApp(), NSAttributedString.Key.font: UIFont.fontChange(type: .Medium, fontSize: 17)]
            barApp.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.colorStatuteNameApp(), NSAttributedString.Key.font: UIFont.fontChange(type: .Medium, fontSize: 17)]
        ...
        //: } else {
            ...
            navigationBar.setBackgroundImage(UIImage.beginLine(color: UIColor.white), for: .any, barMetrics: .default)
            //: navigationBar.shadowImage = UIImage.init()
            navigationBar.shadowImage = UIImage.init()
            //: navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.colorStatuteNameApp(), NSAttributedString.Key.font: UIFont.fontChange(type: .Medium, fontSize: 17)]
            navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.colorStatuteNameApp(), NSAttributedString.Key.font: UIFont.fontChange(type: .Medium, fontSize: 17)]
        }
        //: UINavigationBar.appearance().tintColor = UIColor.colorStatuteNameApp()
        UINavigationBar.appearance().tintColor = UIColor.colorStatuteNameApp()
...
extension MissiveThen: UINavigationControllerDelegate {
...
extension MissiveThen: UIGestureRecognizerDelegate {
