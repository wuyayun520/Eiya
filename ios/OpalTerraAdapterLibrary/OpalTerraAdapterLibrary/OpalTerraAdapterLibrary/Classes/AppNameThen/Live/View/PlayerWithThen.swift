...
fileprivate let k_groupTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_tc_warn" :*/
fileprivate let k_toName:[Character] = ["i","c","o","n","_","t","c","_"]
fileprivate let k_countStr:String = "wequaln"

/*: "Live Warning" :*/
fileprivate let k_dataPath:String = "curve for if endLive W"
fileprivate let k_observerName:[Character] = ["a","r","n","i","n","g"]

/*: "OK" :*/
fileprivate let kContextKey:[Character] = ["O","K"]

/*: "Violation Reason: " :*/
fileprivate let kDefineValue:String = "Violatself medium mask"
fileprivate let kWhitePath:String = "eason: top top make view"

/*: "Warning Time: " :*/
fileprivate let kContainerStr:[Character] = ["W","a","r","n","i","n","g"]
fileprivate let k_viewYouUrl:String = " Time: path raw"
...
class PlayerWithThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_groupTitle.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.submitGift(name: "icon_tc_warn")
        iamg.image = UIImage.submitGift(name: (String(k_toName) + k_countStr.replacingOccurrences(of: "equal", with: "ar")))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.textColor = .colorStatuteNameApp()
        //: lab.font = UIFont.fontChange(type: .Semibold, fontSize: 18)
        lab.font = UIFont.fontChange(type: .Semibold, fontSize: 18)
        //: lab.textAlignment = .center
        lab.textAlignment = .center
        //: lab.text = "Live Warning".localized
        lab.text = (String(k_dataPath.suffix(6)) + String(k_observerName)).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(videoDismiss), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension PlayerWithThen {
    ...
    func heritage(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.increase()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(kDefineValue.prefix(6)) + "ion R" + String(kWhitePath.prefix(7))).localized
        ...
        var timeText = (String(kContainerStr) + String(k_viewYouUrl.prefix(7))).localized
