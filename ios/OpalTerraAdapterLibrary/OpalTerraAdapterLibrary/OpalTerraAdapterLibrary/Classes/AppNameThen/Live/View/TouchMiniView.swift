...
fileprivate let kLeadingName:[UInt8] = [0x34,0x33,0x34,0x29,0x75,0x3e,0x32,0x39,0x38,0x2f,0x67,0x74,0x7d,0x35,0x3c,0x2e,0x7d,0x33,0x32,0x29,0x7d,0x3f,0x38,0x38,0x33,0x7d,0x34,0x30,0x2d,0x31,0x38,0x30,0x38,0x33,0x29,0x38,0x39]
...
class TouchMiniView: ObjectMiniView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kLeadingName.map{$0^93}, encoding: .utf8)!)
    }
...
extension TouchMiniView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func toTheHighestDegreeImportantFootballerUrl(liveUrl: String) {
...
extension TouchMiniView: TXLivePlayListener {
...
extension TouchMiniView {
    ...
    private func pathQuantityeraction() {
