...
fileprivate let kIndexContent:[UInt8] = [0xf4,0xf3,0xf4,0xe9,0xb5,0xfe,0xf2,0xf9,0xf8,0xef,0xa7,0xb4,0xbd,0xf5,0xfc,0xee,0xbd,0xf3,0xf2,0xe9,0xbd,0xff,0xf8,0xf8,0xf3,0xbd,0xf4,0xf0,0xed,0xf1,0xf8,0xf0,0xf8,0xf3,0xe9,0xf8,0xf9]

/*: "Online Users" :*/
fileprivate let kPathId:String = "Onlincontent make var self add"
fileprivate let kHiddenName:String = "e Userserror make size if"
...
class RangePopView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kIndexContent.map{$0^157}, encoding: .utf8)!)
    }
    ...
    private lazy var dismissBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(exceptMessage), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var tipsLb: UILabel = {
        ...
        lb.text = (String(kPathId.prefix(5)) + String(kHiddenName.prefix(7))).localized
        //: return lb
        return lb
        //: }()
    }()
...
extension RangePopView {
    ...
    private func cloud() {
        ...
        LimitReactiveCompatible().overClear(chatGroupId: self.chatGroupId) { succeed, result, _ in
            ...
            if succeed {
                ...
                if let datas = Array<ViewTextListModel>.deserialize(from: array as? Array) {
...
extension RangePopView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.screenShared(model: self.DataSource[indexPath.row], index: indexPath.row)
        //: return cell!
        return cell!
    }
...
extension RangePopView {
    ...
    @objc private func exceptMessage() {
        //: dismiss()
        equalGenerate()
    }
    ...
    func clientRequest(chatGroupId: String) {
