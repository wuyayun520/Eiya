...
class LeagueTogetherModelType: HandyJSON {
    //: var roomId = ""                           // trtc房间号
    var roomId = "" // trtc房间号
    //: var streamerInfo = TalkingStreamerInfo()
    var streamerInfo = RangeStreamerInfo() // 主播信息
    //: var livePlayUrl = ""                      // CDN旁路直播拉流地址
    var livePlayUrl = "" // CDN旁路直播拉流地址
    //: var gameList = [TalkingGameListModel]()
    var gameList = [PitchListModel]() // 游戏列表
...
class RangeStreamerInfo: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var headPic = ""
    var headPic = ""
...
class PitchListModel: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""
