...
fileprivate let kBarrierData:[UInt8] = [0xa6,0xab,0xa6,0xb1,0x65,0xa0,0xac,0xa1,0xa2,0xaf,0x77,0x66,0x5d,0xa5,0x9e,0xb0,0x5d,0xab,0xac,0xb1,0x5d,0x9f,0xa2,0xa2,0xab,0x5d,0xa6,0xaa,0xad,0xa9,0xa2,0xaa,0xa2,0xab,0xb1,0xa2,0xa1]

fileprivate func stateLab(receive num: UInt8) -> UInt8 {
...
class DisappearView: AtView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kBarrierData.map{stateLab(receive: $0)}, encoding: .utf8)!)
    }
    ...
    override func toAnimating() {
        ...
        let filePath = FinancialAidThen.shared.rent(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.happeningSuccess(effectItemView: self, success: true)
...
extension DisappearView: SVGAPlayerDelegate {
