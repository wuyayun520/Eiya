...
fileprivate let k_acrossTitle:[UInt8] = [0x3f,0x44,0x3f,0x4a,0xfe,0x39,0x45,0x3a,0x3b,0x48,0x10,0xff,0xf6,0x3e,0x37,0x49,0xf6,0x44,0x45,0x4a,0xf6,0x38,0x3b,0x3b,0x44,0xf6,0x3f,0x43,0x46,0x42,0x3b,0x43,0x3b,0x44,0x4a,0x3b,0x3a]

fileprivate func imageMake(normal num: UInt8) -> UInt8 {
...
/*: "all" :*/
fileprivate let k_pathRequestUrl:[Character] = ["a","l","l"]
...
class VideoThen: ObjectStreamMsgCell {
    //: var giftData: TalkingGroupChatGiftMsgCellData?
    var giftData: ItemCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_acrossTitle.map{imageMake(normal: $0)}, encoding: .utf8)!)
    }
...
extension VideoThen {
    ...
    override func afterMid(with data: DisappearReactiveCompatible) {
        ...
        self.giftData = data as? ItemCellData
        ...
        if giftData.msgModel.toUser.uid == (String(k_pathRequestUrl)) { // 送礼所有人
            //: self.toUserImgView.image = UIImage.submitGift(name: giftData.msgModel.toUser.headPic)
            self.toUserImgView.image = UIImage.submitGift(name: giftData.msgModel.toUser.headPic)
            //: } else {
        } else {
