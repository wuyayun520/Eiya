...
@property (nonatomic, strong)WithSizeModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)HeritageModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)OutputModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)WithModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)MakeModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)LockModel *quoteMsgInfo;

//: @property (nonatomic, strong)HumankindThen *userInfoModel;
@property (nonatomic, strong)HumankindThen *userInfoModel;
...
@interface WithSizeModel : JSONModel
...
@property (nonatomic, strong) TimeExposureModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) OeuvreModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) MatchModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) SizeModel *wantGift; /// 想要礼物
...
@interface TimeExposureModel : JSONModel
...
@interface OeuvreModel: JSONModel
...
@interface HeritageModel : JSONModel
...
@interface OutputModel : JSONModel
...
@property (nonatomic, strong) HideModel *renderData;
