...
fileprivate let kImageText:[UInt8] = [0xd9,0xde,0xd9,0xc4,0x98,0xd3,0xdf,0xd4,0xd5,0xc2,0x8a,0x99,0x90,0xd8,0xd1,0xc3,0x90,0xde,0xdf,0xc4,0x90,0xd2,0xd5,0xd5,0xde,0x90,0xd9,0xdd,0xc0,0xdc,0xd5,0xdd,0xd5,0xde,0xc4,0xd5,0xd4]
...
class ValueShieldView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func everySegmentKey(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return ValueShieldView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kImageText.map{$0^176}, encoding: .utf8)!)
    }
