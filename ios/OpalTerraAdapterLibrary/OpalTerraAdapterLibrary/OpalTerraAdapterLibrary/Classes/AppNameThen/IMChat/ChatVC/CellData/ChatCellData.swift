...
/*: _" :*/
fileprivate let k_giftUrl:String = "_"

/*: ".png" :*/
fileprivate let k_backName:String = "text target component mess.png"
...
@objcMembers public class ChatCellData: GroupReactiveCompatible {
    ...
    override public var msgModel: ContentModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.unleash(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func aboveInfo(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(showBottomName)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + DistanceAppManager.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + DistanceAppManager.share.loginUserMode.userID + (String(k_backName.suffix(4)))
