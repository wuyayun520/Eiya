 ...
 *
 *  ShowDelegate 协议和 MagnitudeernationalismTableViewController 类。
 *  MagnitudeernationalismTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 MagnitudeernationalismTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class MagnitudeernationalismTableViewController;
//: @class MakeMessageCell;
@class MakeMessageCell;
//: @class InscriptionThen;
@class InscriptionThen;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
- (void)didTapInMessageController:(MagnitudeernationalismTableViewController *)controller;
...
- (void)didHideMenuInMessageController:(MagnitudeernationalismTableViewController *)controller;
...
- (BOOL)messageController:(MagnitudeernationalismTableViewController *)controller willShowMenuInCell:(UIView *)view;
 ...
 */
//: - (InscriptionThen *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (InscriptionThen *)messageController:(MagnitudeernationalismTableViewController *)controller onNewMessage:(V2TIMMessage *)data;
 ...
 */
//: - (MakeMessageCell *)messageController:(TUIMessageController *)controller onShowMessageData:(InscriptionThen *)data;
- (MakeMessageCell *)messageController:(MagnitudeernationalismTableViewController *)controller onShowMessageData:(InscriptionThen *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(MakeMessageCell *)cell;
- (void)messageController:(MagnitudeernationalismTableViewController *)controller onSelectMessageAvatar:(MakeMessageCell *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(MakeMessageCell *)cell;
- (void)messageController:(MagnitudeernationalismTableViewController *)controller onSelectMessageContent:(MakeMessageCell *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(InscriptionThen *)data;
- (void)messageController:(MagnitudeernationalismTableViewController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(InscriptionThen *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(MakeMessageCell *)cell;
- (void)messageController:(MagnitudeernationalismTableViewController *)controller onRetryMessageContent:(MakeMessageCell *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(InscriptionThen *)cellData;
- (void)messageController:(MagnitudeernationalismTableViewController *)controller onReplyMessage:(InscriptionThen *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(InscriptionThen *)cellData;
- (void)messageController:(MagnitudeernationalismTableViewController *)controller onClickReplyMessage:(InscriptionThen *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         MagnitudeernationalismTableViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】MagnitudeernationalismTableViewController
...
@interface MagnitudeernationalismTableViewController : UITableViewController

/**
 *  执行 ShowDelegate 协议的委托
 */
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<InscriptionThen *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成InscriptionThen
 */
