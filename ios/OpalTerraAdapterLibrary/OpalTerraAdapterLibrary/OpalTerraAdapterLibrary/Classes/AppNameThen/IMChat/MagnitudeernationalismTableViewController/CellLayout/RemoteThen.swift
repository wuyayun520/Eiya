...
@objcMembers public class RemoteThen: NSObject {
    ...
    class func cipherPostStatus() -> RemoteThen {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = RemoteThen.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func shimmerService() -> RemoteThen {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = RemoteThen.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func roundErase() -> RemoteThen {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = RemoteThen.init(isIncomming: false)
    ...
    class func nameTime() -> RemoteThen {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = RemoteThen.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func subLocal() -> RemoteThen {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = RemoteThen.init(isIncomming: false)
        //: return layout
        return layout
