...
@objc public enum AddWidthQuantity: UInt {
...
@objc public enum UserAppMeasurable: UInt {
...
// MARK: - InscriptionThen

/**
 * 【模块名称】InscriptionThen
 ...
 */
//: @objcMembers public class InscriptionThen: TCommonCellData {
@objcMembers public class InscriptionThen: DisappearReactiveCompatible {
    ...
    public var direction: UserAppMeasurable = .MsgDirectionIncoming
    ...
    public var translateStatus: AddWidthQuantity = .MsgTranslate_init
    ...
    public var msgModel: ContentModel = ContentModel()
    ...
    public var cellLayout: RemoteThen!
    ...
    public init(direction: UserAppMeasurable) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.rectangle()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = RemoteThen(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = RemoteThen(isIncomming: false)
