...
@objcMembers public class DisappearReactiveCompatible: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func pathDetail(_ width: CGFloat) -> CGFloat {
    public func pathDetail(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
...
@objcMembers public class MakeNameReactiveCompatible: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: DisappearReactiveCompatible?
    ...
    @objc dynamic public func afterMid(with data: DisappearReactiveCompatible) {
        //: self.data = data
        self.data = data
    }
} 
