...
extension Dictionary {
    ...
    public static func dataPath(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func sinceFrom(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.dataPath(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
