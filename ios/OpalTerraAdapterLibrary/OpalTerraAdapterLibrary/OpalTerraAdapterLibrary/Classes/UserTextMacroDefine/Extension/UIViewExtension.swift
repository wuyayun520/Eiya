...
extension UIView {
    ...
    func imageUser(width: CGFloat, height: CGFloat, corners: UIRectCorner, cornerRadii: CGSize) {
    ...
    func viewShadowinessRadii(width: CGFloat, height: CGFloat, corners: UIRectCorner, cornerRadii: CGSize)->CAShapeLayer {
        //: let maskBezier = UIBezierPath.init(roundedRect: CGRect.init(x: 0, y: 0, width: width, height: height), byRoundingCorners: corners, cornerRadii: cornerRadii)
        let maskBezier = UIBezierPath.init(roundedRect: CGRect.init(x: 0, y: 0, width: width, height: height), byRoundingCorners: corners, cornerRadii: cornerRadii)
        //: let maskLayer = CAShapeLayer.init()
        let maskLayer = CAShapeLayer.init()
