...
@objcMembers open class MakeLanguageManager: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = MakeLanguageManager()
    //: private(set) var currLanguage: String = UserTextMacroDefine.getSystemLangCode()
    private(set) var currLanguage: String = UserTextMacroDefine.societalLoad()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func marginFirst(_ language: String) {
...
extension String {
    ...
    public func edgeDelay(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = VideoEffectTool.default.languagePath
