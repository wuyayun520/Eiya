...
fileprivate let kGestureNameMessage:String = "btn_gift for remove"
fileprivate let k_addFormat:String = "play var makeack_"
fileprivate let kPlusFormat:String = "cellue"

/*: "init(coder:) has not been implemented" :*/
fileprivate let kAppStr:[UInt8] = [0x3e,0x39,0x3e,0x23,0x7f,0x34,0x38,0x33,0x32,0x25,0x6d,0x7e,0x77,0x3f,0x36,0x24,0x77,0x39,0x38,0x23,0x77,0x35,0x32,0x32,0x39,0x77,0x3e,0x3a,0x27,0x3b,0x32,0x3a,0x32,0x39,0x23,0x32,0x33]

private func userMain(push num: UInt8) -> UInt8 {
    return num ^ 87
}
...
class MasterThen: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(distantSquare), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(perquisiteEqualSpeak), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: VideoAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(kGestureNameMessage.prefix(4)) + "me_b" + String(k_addFormat.suffix(4)) + "cont" + kPlusFormat.replacingOccurrences(of: "cell", with: "in"))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kAppStr.map{userMain(push: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func sprechstimme(title: String, isTouch: Bool) {
