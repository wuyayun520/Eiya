...
enum PalmClusterLiteral: String {
    //: case AppleLogin
...
enum PositionEffectInsetTarget: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
enum BreakValueConvertible: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum CoverFileReplaceableCollection: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum WithStatusTitleConvertible: Int {
    //: case isOnGoing = 0
...
@objc enum NameQuickLookable: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum SizeHashableRepresentation: Int {
    //: case Unavailable = 0
...
enum CustomCellType: CaseIterable {
