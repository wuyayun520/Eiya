...
class PulchritudeViewLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        layoutContentSize = CGSize(width: Int(constFormalContent) * page, height: 2*GiftItemHeight)
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let x = page * Int(constFormalContent) + pageCol * (itemWidth )
