...
//: @objcMembers public class RangeReactiveCompatible: JSONModel {
@objcMembers public class RangeReactiveCompatible: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = JoinHashableRepresentation.Face
...
//: @objc extension RangeReactiveCompatible {
@objc extension RangeReactiveCompatible {
    //: func initWith(suiteType: BeautyItemType)-> RangeReactiveCompatible {
    func rowBy(suiteType: JoinHashableRepresentation) -> RangeReactiveCompatible {
        //: let model = RangeReactiveCompatible.init()
        let model = RangeReactiveCompatible()
