...
fileprivate let kPlayerValueMsg:[Character] = ["A","r","e","a"]
fileprivate let kUserPath:[Character] = ["C","o","d","e","C","h","o","i","c","e","C","e","l","l","I","D"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let k_makeEqualNorStr:[UInt8] = [0x72,0x75,0x72,0x6f,0x33,0x78,0x74,0x7f,0x7e,0x69,0x21,0x32,0x3b,0x73,0x7a,0x68,0x3b,0x75,0x74,0x6f,0x3b,0x79,0x7e,0x7e,0x75,0x3b,0x72,0x76,0x6b,0x77,0x7e,0x76,0x7e,0x75,0x6f,0x7e,0x7f]

private func resultTap(size num: UInt8) -> UInt8 {
    return num ^ 27
}

/*: "Select Country Code" :*/
fileprivate let kTimeName:[Character] = ["S","e","l","e","c","t"," ","C","o","u","n","t","r"]
fileprivate let k_submitFileKey:String = "y Codeadd false manager content live"

/*: "#F4F6FA" :*/
fileprivate let k_layerId:String = "#F4F6FAsave path"
...
class TennisPlayerDataSource: StartThen {
    //: public var backCountryCode: ((TalkingAreaModel) -> Void)?
    public var backCountryCode: ((DataHandyJSON) -> Void)?

    //: private let TalkingAreaCodeChoiceCellID = "AreaCodeChoiceCellID"
    private let TalkingAreaCodeChoiceCellID = (String(kPlayerValueMsg) + String(kUserPath))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_makeEqualNorStr.map{resultTap(size: $0)}, encoding: .utf8)!)
    }
    ...
    override func viewDidLoad() {
        ...
        self.title = (String(kTimeName) + String(k_submitFileKey.prefix(6))).localized
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(LanguageChoiceCell.classForCoder(), forCellReuseIdentifier: TalkingAreaCodeChoiceCellID)
        ...
        tableView.backgroundColor = UIColor(hex: (String(k_layerId.prefix(7))))
        //: return tableView
        return tableView
        //: }()
    }()
...
extension TennisPlayerDataSource {
    //: private func createDefaultData() {
    private func aboveColor() {
        ...
        for areaModel: DataHandyJSON in arr {
        ...
        for index in 0 ..< sectionNumb {
            ...
            let sortArr = collation.sortedArray(from: tempArr, collationStringSelector: #selector(getter: DataHandyJSON().areaName))
...
extension TennisPlayerDataSource: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if sectionArray.count > section {
            ...
            let array: [DataHandyJSON] = sectionArray[section] as! [DataHandyJSON]
            //: return array.count
            return array.count
        }
        //: return 0
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: LanguageChoiceCell = tableView.dequeueReusableCell(withIdentifier: TalkingAreaCodeChoiceCellID, for: indexPath) as! LanguageChoiceCell
        //: let array: [TalkingAreaModel] = sectionArray[indexPath.section] as! [TalkingAreaModel]
        let array: [DataHandyJSON] = sectionArray[indexPath.section] as! [DataHandyJSON]
        //: cell.func__updateUIWithModel(areaModel: array[indexPath.row])
        cell.eventModel(areaModel: array[indexPath.row])
    ...
    func tableView(_: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headView.frame = CGRect(x: 0, y: 0, width: constFormalContent, height: 30)
        ...
        label.frame = CGRect(x: 15, y: 0, width: constFormalContent - 30, height: 30)
