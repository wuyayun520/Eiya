...
/*: "&sr=6" :*/
fileprivate let k_attentionFormat:String = "as since color&sr=6"
...
enum SizeTransformable: String, CaseIterable {
...
enum CounterwomanCustomReflectable: String {
...
class OriginalManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func actionFile(urlType: CounterwomanCustomReflectable) -> String {
        //: var url = DistanceAppManager.share.appConfigMode.urlH5Domain
        var url = DistanceAppManager.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(DistanceAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : DistanceAppManager.share.appUserConfigMode.fullRechargePage)
            url.append(DistanceAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : DistanceAppManager.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(DistanceAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : DistanceAppManager.share.appUserConfigMode.halfRechargePage)
            url.append(DistanceAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : DistanceAppManager.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = DistanceAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = DistanceAppManager.share.appUserConfigMode.halfRechargePage.appending((String(k_attentionFormat.suffix(5))))
            //: url.append(DistanceAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(DistanceAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
