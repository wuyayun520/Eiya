...
fileprivate let kManagerContent:[UInt8] = [0xaf,0xb4,0xaf,0xba,0x6e,0xa9,0xb5,0xaa,0xab,0xb8,0x80,0x6f,0x66,0xae,0xa7,0xb9,0x66,0xb4,0xb5,0xba,0x66,0xa8,0xab,0xab,0xb4,0x66,0xaf,0xb3,0xb6,0xb2,0xab,0xb3,0xab,0xb4,0xba,0xab,0xaa]

fileprivate func burnMake(fatal num: UInt8) -> UInt8 {
...
/*: "JXBannerCellID" :*/
fileprivate let k_indexBarTitle:String = "JXBantype frame"
fileprivate let kTextCameraMessage:String = "let app selfellID"
...
class CaptureView: UITableViewCell {
    //: private var adBannderListData = [SocialAdBannerModel]()
    private var adBannderListData = [AdMeasurable]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kManagerContent.map{burnMake(fatal: $0)}, encoding: .utf8)!)
    }
...
extension CaptureView: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(k_indexBarTitle.prefix(5)) + "nerC" + String(kTextCameraMessage.suffix(5))))
    }
...
extension CaptureView {
    ...
    func stopResource(bannerData: [AdMeasurable]) {
