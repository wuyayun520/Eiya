...
Pod::Spec.new do |s|
  s.name         = "OpalTerraAdapterLibrary"
  s.version      = "1.0.0"
  s.summary      = "iOS OpalTerraAdapterLibrary Module."
  s.author       = { "OpalTerraAdapterLibrary" => "OpalTerraAdapterLibrary.me" }
  s.homepage     = "OpalTerraAdapterLibrary"
  s.source       = { :git => "http://OpalTerraAdapterLibrary.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'OpalTerraAdapterLibrary/Classes/**/*'
  s.resources = "OpalTerraAdapterLibrary/Resources/*.bundle"
  s.vendored_libraries = 'OpalTerraAdapterLibrary/Classes/**/*.a'
